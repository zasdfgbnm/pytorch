...
std::tuple<std::vector<int64_t>, std::vector<int64_t> > gather_infer_size(IntArrayRef self, IntArrayRef index, int64_t &dim) {
...
std::tuple<std::vector<int64_t>, std::vector<int64_t> > scatter_infer_size(IntArrayRef self, IntArrayRef index, IntArrayRef src, int64_t &dim) {
  auto dimsA = self.size();
  auto dimsB = index.size();
  auto dimsC = src.size();
...
Tensor & gather_out(Tensor & result, const Tensor & self, int64_t dim, const Tensor & index, bool sparse_grad) {
  ...
  return at::legacy::th::_th_gather_out(result, b_self, dim, b_index);
}

Tensor gather(const Tensor & self, int64_t dim, const Tensor & index, bool sparse_grad) {
  Tensor b_self, b_index;
  std::tie(b_self, b_index) = gather_expand(self, index, "gather", dim);
  return at::legacy::th::_th_gather(b_self, dim, b_index);
}
...
Tensor & scatter_(Tensor& self, int64_t dim, const Tensor & index, const Tensor & src) {
  ...
  return at::legacy::th::_th_scatter_(self, dim, b_index, b_src);
}

Tensor & scatter_(Tensor& self, int64_t dim, const Tensor & index, Scalar value) {
  Tensor b_index, b_src;
  std::tie(b_index, b_src) = scatter_expand(self, index, self.type().scalarTensor(value), "scatter_", dim);
  return at::legacy::th::_th_scatter_(self, dim, b_index, b_src);
}
...
Tensor & scatter_add_(Tensor& self, int64_t dim, const Tensor & index, const Tensor & src) {
  ...
  return at::legacy::th::_th_scatter_add_(self, dim, b_index, b_src);
}
